...
export default {
  ...
  data() {
    return {
      ...
      newDate:[1,30],
      dateName:'',
      chartData: [49.9,49.9,49.9,49.9, 71.5, 106.4, 129.2, 144.0,49.9, 71.5, 106.4, 129.2, 144.0, 176.0, 135.6, 148.5, 216.4, 194.1, 95.6, 54.4, 95.6, 54.4, 95.6, 54.4, 95.6, 54.4, 95.6, 54.4,95.6, 54.4,95.6],
    };
  }
};
</script>
